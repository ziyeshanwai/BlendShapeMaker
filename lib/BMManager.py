...
class BMMng():
    ...
    def RescaleAvatar(self):
        ...
        # print("AvatarSize: x[%f, %f], y[%f, %f], z[%f, %f]".format(xs, xl, ys, yl, zs, zl))
    ...
    def TriangleCorrespondence(self, level):
        ...
        for k in range(0, len(SourceFaces)):
        ...
        for i in range(0, len(SourceFaces)):
        ...
        def MakeEs_ATA_ATc():
            ...
            for i in range(0, len(self.Adjacent)):
                for j in range(0, len(self.Adjacent[i])):
                    adj_num+=1
